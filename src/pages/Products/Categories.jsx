...
const Categories = () => {
  ...
  return (
    <div className="bg-black">
      <nav className="flex justify-between items-center h-16 px-6 border-b-4 border-teal-400 text-lg bg-linear-to-r from-teal-700 via-gray-900 to-black lg:font-semibold text-white shadow-lg">
        {/* Title */}
