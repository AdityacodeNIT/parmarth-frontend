        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          <div>
            <input
              ...
              } w-full p-3 rounded-md focus:outline-hidden focus:ring-2 focus:ring-blue-500`}
            />
            {errors.firstName && (
          ...
          <input
            ...
            onChange={handleInputChange}
            className="border-2 border-gray-300 w-full p-3 rounded-md focus:outline-hidden focus:ring-2 focus:ring-blue-500"
          />
          <input
            type="text"
            name="landmark"
