...
const BuyProduct = () => {
  const { totalProductPrice, productDesccription, setAddressId } = useContext(UserContext);
  ...
  useEffect(() => {
    const fetchAddressDetails = async () => {
      try {
        ...
        setError("Failed to load address details kindly login first if you are not logged in yet.");
        setLoading(false);
      }
    };
