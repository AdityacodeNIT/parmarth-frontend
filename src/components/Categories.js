...
const Categories = () => {
  return (
    <div className=" bg-cream-500">
      <nav className="flex justify-evenly h-14  border-b-4 border-pink-400 text-lg bg-gradient-to-r from-blue-700 via-indigo-600  to-violet-700  lg:font-semibold font-md text-white ">
