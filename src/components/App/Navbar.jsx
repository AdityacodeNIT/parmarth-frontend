      ...
      <div className="flex w-full items-center justify-between h-full">
        ...
        >
          <ul className="flex flex-col md:flex-row w-full md:w-auto items-center space-y-4 md:space-y-0">
            <li className="md:mx-3 text-md lg:text-lg text-[#FACC15] font-semibold hover:text-[#38BDF8] transition-colors duration-200">
              <Link to="/" onClick={() => setMenuOpen(false)}>Home</Link>
            </li>
            <li className="md:mx-3 text-md lg:text-lg font-semibold text-[#FACC15] hover:text-[#38BDF8] transition-colors duration-200">
