        ...
        <div className='container mx-auto px-6 py-6 grid gap-8 grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4'>
          {searchResult.map(product => (
            <Link to={`/product/${product._id}`} key={product._id}>
              <div className='bg-gray-800 rounded-lg shadow-lg border border-gray-700 p-4 transition-transform transform hover:-translate-y-2 hover:scale-105 hover:shadow-2xl'>
                {/* Product Image */}
